...
unique(all$name)
ggplot(all %>% filter(name!="metadata_subset_5e-06.tsv",name!="metadata_subset_5e-05.tsv",name!="metadata_subset_0.01.tsv"),aes(x=days_diff,color=name))+geom_density()+coord_cartesian(xlim=c(-60,60))+theme_bw()+scale_color_brewer(type="qual")
